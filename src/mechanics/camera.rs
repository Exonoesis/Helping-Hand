...
pub fn move_camera(
    ...
    mut camera_query: Query<(&mut Transform, &OrthographicProjection), (Changed<Transform>, With<Camera2d>, Without<Player>)>,
) {
    ...
    if camera_width > level_dimension.width as f32 {
        ...
        camera_transform.translation.x = camera_transform.translation.x.clamp(camera_width / 2.0, level_dimension.width as f32 - (camera_width / 2.0));
    }
    ...
    if camera_height > level_dimension.height as f32 {
        ...
        camera_transform.translation.y = camera_transform.translation.y.clamp(camera_height / 2.0, level_dimension.height as f32 - (camera_height / 2.0));
    }
}