Feature: Get map instruction information from a Tiled map
    Scenario: Character and Placement Location Coordinates are both found.
        ...
        Given a Tiled map called 'some_map.tmx',
        ...
        Then the placement result should have the character at coordinates 1, 4.
        And the placement result should have the location at coordinates 4, 1.
